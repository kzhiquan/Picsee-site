                ...
                <div class="flex">
                    <div class="py-8 pl-4">
                        ...
                        <ul class="list-disc text-base text-gray-700 pl-10 pt-3">
                            ...
                            <li>支持bmp、dds、exr、gif、pic、ico、jpeg、jpeg2000、pbm、pict、png、psd、sgi、tga、tiff、cr2、dng、heic、heif、jp2、nef、nrw、orf、pef、raf、rw2、webp、folder等格式，以及各种RAW格式图片的查看处理</li>
                        </ul>
                    </div>
                </div>
            </div>
